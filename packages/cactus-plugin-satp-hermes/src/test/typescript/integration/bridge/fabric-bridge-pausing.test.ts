...
describe("Fabric Bridge Test", () => {
  ...
  it("Should pause the bridge", async () => {
    const responsePause = await fabricBridge.pauseBridge();
    expect(responsePause).not.toBeUndefined();
    expect(responsePause.transactionId).not.toBeUndefined();
    expect(responsePause.output).not.toBeUndefined();
    log.info("Bridge paused successfully");

    const responseIsPaused = await fabricBridge.bridgeIsPaused();
    expect(responseIsPaused).not.toBeUndefined();
    expect(responseIsPaused.transactionId).not.toBeUndefined();
    expect(responseIsPaused.output).not.toBeUndefined();
    log.info("Bridge is paused");
  });

  it("Should try to Lock an asset while the bridge is paused and fail", async () => {
  ...
  it("Should unpause the bridge and Lock an asset", async () => {
    const responseUnpause = await fabricBridge.unpauseBridge();
    expect(responseUnpause).not.toBeUndefined();
    expect(responseUnpause.transactionId).not.toBeUndefined();
    expect(responseUnpause.output).not.toBeUndefined();
    log.info("Bridge unpaused successfully");
