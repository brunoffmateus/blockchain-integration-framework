...
export class BesuTestEnvironment {
  ...
  // Sets up the Besu Ledger and Connector to be used in the tests
  ...
  // Creates a JSON object containing the necessary Besu configuration
  ...
  // Also creates bungeeOptions and besuConfig
