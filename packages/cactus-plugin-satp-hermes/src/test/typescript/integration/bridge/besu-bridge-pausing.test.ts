...
describe("Besu Bridge Test", () => {
  ...
  it("Should pause the bridge", async () => {
    const response = await besuBridge.pauseBridge();
    expect(response).toBeDefined();
    expect(response.transactionId).toBeDefined();
    expect(response.transactionReceipt).toBeDefined();
    log.info("Bridge paused successfully");

    const response2 = await besuBridge.bridgeIsPaused();
    expect(response2).toBeDefined();
  ...
  it("Should try to Lock a token while the bridge is paused and fail", async () => {
  ...
  it("Should unpause bridge", async () => {
    const response = await besuBridge.unpauseBridge();
    expect(response).toBeDefined();
    expect(response.transactionId).toBeDefined();
    expect(response.transactionReceipt).toBeDefined();
    log.info("Bridge unpased successfully");
  });
