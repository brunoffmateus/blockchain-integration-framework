...
beforeAll(async () => {
  ...
  endTime = new Date();
  console.log(`EVAL-STARTUP1-${endTime.getTime() - startTime.getTime()} ms`);
});
...
describe("Pausing all SATP bridges at once", () => {
  ...
  it("should pause the bridges due to non-conformance", async () => {
    ...
    console.log("Transaction was canceled due to paused bridges."); //6301, 6033, 7323, 4898, 10395
